...
def test():
    ...
    detunings = np.random.normal(loc=0, scale=0.5, size=30_000)
    Omegas = [[1.0, 0.0, detuning] for detuning in detunings]
    ...
    rs = solver.run_multiple_averaged(Omegas, step, n_steps)
